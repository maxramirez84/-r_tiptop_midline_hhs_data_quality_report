...
api_token = api_token_drc # TIPTOP HHS Midline DRC
...
study_area_id           = 2
study_area_label        = "Bulungu"
study_area_column       = "bulungu"
sample_size             = 544
household_to_be_visited = 1975

data_timestamp = dataTimestamp(data_retrieval_mode, file_date, file_time)
```

---
title: "TIPTOP Midline HHS Rapport de Qualité de Données: RDC - BULUNGU"
...
```
[Dépôt GitHub du Rapport](https://github.com/maxramirez84/r_tiptop_baseline_hhs_data_quality_report)

## PROGRÈS DE LA COLLECTE DE DONNÉES SUR TERRAIN

La base de données contient `r number_of_records` enregistrements (dernier enregistrement du `r last_record_date`).
...
<div class="col-left text-center">
  Femmes Interviewées @ `r study_area_label`
...
progressOfArea(hhs_data, study_area_column, study_area_label, interval = 10, required_visits_mean = 60, lang = 'FR')
```
