...
api_token = hhs_endline_mada # TIPTOP HHS Endline DRC
non_retrieved_records = c("cluster", "facility")
# File
file_prefix = "TIPTOPHHSEndlineMadagascarMALGACHE"
...
`r language$progress.partner` [`r partner.name`](http://www.manisa.mg).
